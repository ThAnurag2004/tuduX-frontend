    ...
    <div className="bg-black min-h-screen flex justify-center items-center px-4 py-6">
      <div className="bg-white p-6 sm:p-10 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <button
            type="submit"
            className="w-full py-2 sm:py-3 bg-black text-white rounded-lg hover:bg-white hover:text-black border-2 transition-all cursor-pointer duration-300 text-sm sm:text-base"
          >
            Sign Up
          </button>
        </form>
